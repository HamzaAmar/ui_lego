...
export const Extra3SmallHeading = Template.bind({});
Extra3SmallHeading.args = {
  size: '3xs',
};

export const Extra2SmallHeading = Template.bind({});
Extra2SmallHeading.args = {
  size: 'xxs',
};
...
export const Extra3LargeHeading = Template.bind({});

Extra3LargeHeading.args = {
  size: '3xl',
};
